		...
		<?php
            ...
            if($rules!=null){
                ...
                <div class="hotel-rules">
                    <h2>Правила проживания в отеле</h2>                
                    <?php
                    echo $rules;
                    ?>
                </div>
            ...
            if($hotel_url !=null){
                ?>
                <noindex>
                    <a href="<?php echo $hotel_url; ?>" class="th-readmore hotel-link" rel="nofolow" target="_blank">Перейти на сайт отеля</a>
                </noindex>
                <?php
            }
			wp_link_pages( array(
